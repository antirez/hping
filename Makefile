...
#(not raccomanded)
COMPILE_TIME=
INSTALL_MANPATH=/home/synamics/.gentoo/java-config-2/current-user-vm/man
PCAP=-lpcap
...
hping3: byteorder.h $(OBJ)
	$(CC) -o hping3 $(CCOPT) $(DEBUG) $(OBJ) -L/usr/local/lib $(PCAP)  -ltcl[01;31m[K8[m[K.5.[01;31m[Kso[m[K -lm -lpthread
	@echo
	./hping3 -v
...
hping3-static: byteorder.h $(OBJ)
	$(CC) -static -o hping3-static $(CCOPT) $(DEBUG) $(OBJ) -L/usr/local/lib $(PCAP)  -ltcl[01;31m[K8[m[K.5.[01;31m[Kso[m[K -lm -lpthread -ldl
